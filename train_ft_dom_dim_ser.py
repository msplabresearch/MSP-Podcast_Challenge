...
lm = utils.LogManager()
lm.alloc_stat_type_list(["train_dom"])
lm.alloc_stat_type_list(["dev_dom"])
...
for epoch in range(EPOCHS):
    ...
    for xy_pair in tqdm(total_dataloader["train"]):
        ...
        # Logging
        lm.add_torch_stat("train_dom", ccc[0])
    ...
    # Logging
    lm.add_torch_stat("dev_dom", ccc[0])
    ...
    dev_loss = 1.0 - lm.get_stat("dev_dom") 
